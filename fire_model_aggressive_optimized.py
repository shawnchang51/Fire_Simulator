"""
Optimized Aggressive Indoor Fire Spread Model using Cellular Automata
=====================================================================
...
This is a drop-in replacement for fire_model_aggressive.py
"""
...
class AdvancedFireModel:
    ...
    def _calculate_spread_probability(self, current_state: np.ndarray,
        ...
        base_prob = min(neighbor_fire_sum * 0.08, 0.7)
